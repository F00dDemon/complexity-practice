...
public class Main {
  ...
  // The time complexity is:
  // O(n) n = length of letters determined by length of word
  ...
  // The time complexity is:
  // O(1) 1 = length of the banned passwords which is a constant 3, simplified to 1
  ...
  // The time complexity is:
  // O(n) n = size of n - 1 at the beginning.
  ...
  // of the array
  // O(n^2) n = length of the array to the power of the length of the array
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // O(n) = > n = N + n  => each n is length of array
  ...
  // The time complexity is:
  // O(n) = n is the length of characters
  ...
  // O(n) => n is equal to the length of names array
  ...
  public static String emailLookupEfficient(HashMap<String, String> namesToEmails, String queryName) {
    String email = (namesToEmails.get(queryName) != null) ? namesToEmails.get(queryName) : "Person not found";
    return email;
  }
  ...
  // O(n) => n^2 is equal to the number of elements in the set and list
  ...
  // O(n) => n + 1 is equal to the number of elements in the list
